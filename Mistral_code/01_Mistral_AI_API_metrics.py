...
#api_key = "tgUDHfIu7i6i8UtT6LixH8RIP86Cs7Gz"# No Pay

api_key = "bE4uApIjXM9RQRueTx2XsAJN7HpzwJVt" #PAY
...
for i, row in df.iterrows():
    ...
    if (a + 1) % report_every == 0:
        elapsed = time.time() - start_time
        avg_time_per_row = elapsed / (b + 1)
        remaining_rows = len(df) - (a + 1)
