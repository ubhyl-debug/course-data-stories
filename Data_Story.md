...
- Statistics about the data:
  - How many values are `0`, greater than `0`, or less than `0`
  - Total number of responses
  - How many responses contain more than 5 characters
...
<div style="background-color: #ff0000ff; padding: 10px; border: 1px solid #ff0000ff; border-radius: 4px;">

## Offene Punkte:
- OCR Error Measurement for Errors in Articles  
- Historical Events Matching  
- Docker Container and Hosting
- Beispiel Artikel rausziehen
